...
<body style="font-family: sans-serif; background: #f4f4f5; padding: 40px 0;">
  <div style="max-width: 480px; margin: 0 auto; background: #fff; border-radius: 12px; padding: 40px; text-align: center;">
    <h1 style="font-size: 24px; color: #18181b; margin-bottom: 8px;">CyanShip</h1>
        ...
        const t =
            lang === LANG.UK
                ? {
                      ...
                      body: `Ваш акаунт CyanShip деактивовано. Усі дані буде остаточно видалено <strong>${formattedDate}</strong>.`,
                      instruction:
                ...
                : {
                      ...
                      body: `Your CyanShip account has been deactivated. All data will be permanently deleted on <strong>${formattedDate}</strong>.`,
                      instruction:
