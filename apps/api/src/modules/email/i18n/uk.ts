...
export const uk = {
    ...
    briefConfirmation: {
        ...
        body: 'Дякуємо, {{name}}. Ми отримали ваш бриф та незабаром приступимо до розгляду.',
        instruction:
            'Наша команда зв\u2019яжеться з вами протягом 24 годин. Детальну відповідь ви отримаєте на цю електронну адресу.',
