...
export const en = {
    ...
    briefConfirmation: {
        ...
        body: 'Thank you, {{name}}. We have received your project brief and will review it shortly.',
        instruction:
            'Our team will get back to you within 24 hours. You will receive a detailed response to this email address.',
