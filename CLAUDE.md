...
- `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET`, `STRIPE_PRICE_ID_SUBSCRIPTION`
- `RESEND_API_KEY`
...
- `STRIPE_PRICE_ID_CREDITS_5`, `STRIPE_PRICE_ID_CREDITS_10`, `STRIPE_PRICE_ID_CREDITS_20` — тільки якщо `PAYMENTS_ONE_OFF_ENABLED=true`
